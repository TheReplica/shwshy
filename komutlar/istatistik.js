...
module.exports.run = async(client, message, args) => {
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .addField(`Discord.js sürümü:`, Discord.version)
      .addField(':spy: Yapımcım:', '<@465948878445871124> \n `Replica`')
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **28.03.2020**'de yapılmaya başlanmıştır")
    .setFooter('Shwshy', client.user.avatarURL)
    .setTimestamp()
